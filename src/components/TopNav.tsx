...
import { Bell, Zap, RefreshCw, LogOut } from 'lucide-react';
...
export function TopNav() {
  ...
  return (
    <header
      className="fixed top-0 right-0 left-0 z-40 h-16 bg-[#0a0a0a]/90 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-4 lg:px-6"
      style={{ marginLeft: state.sidebarCollapsed ? '64px' : '240px' }}
    >
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 lg:hidden">
          <img src="/Picsart_26-04-10_14-37-41-214.png" alt="NOVA Logo" className="w-6 h-6 object-contain bg-[#0a0a0a] rounded-md p-0.5" />
      ...
      <div className="flex-1"></div>      <div className="flex items-center gap-2">
        <Button
          variant="outline"
          size="sm"
          onClick={runMatching}
        ...
        >
          ...
          {state.engineStatus === 'processing' ? 'Processing...' : 'Run Matching'}
        </Button>
